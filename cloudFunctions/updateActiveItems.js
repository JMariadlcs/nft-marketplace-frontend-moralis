// This script is used to update Cloud Functions on Moralis Database

Moralis.Cloud.afterSave("ItemListed", async (request) => { // Everytime ItemList table is saved -> a function is executed
    const confirmed = request.object.get("confirmed")
    const logger = Moralis.Cloud.getLogger()
    logger.info("Looking for confirmed TX...")
    if (confirmed) {
        logger.info("Found item!")
        const ActiveItem = Moralis.Object.extend("ActiveItem") // Create "ActiveItem" table
